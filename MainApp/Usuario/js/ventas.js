...
Array.from(agregar).forEach(elemento => {
    elemento.addEventListener('click', function(){
        const id = elemento.getAttribute('data-id');
        const accion = elemento.value;
    ...
    peticion.onload = function(){
        if(this.status === 200){
            ...
            if(respuesta.respuesta === 'correcto'){
                ...
                $('.btn-agregar[data-id="'+ respuesta.ID_producto +'"]').css('background-color','red');
    ...
    peticion.onload =  function(){
        if(this.status === 200){
            ...
            if(respuesta.respuesta === 'correcto'){
                ...
                $('.btn-agregar[data-id="'+ respuesta.ID_producto +'"]').css('background-color','#19b925');   
...
function Comprar(){
    ...
    Pedido.append('Hora', hora);
    Pedido.append('Fecha', fecha);
    ...
    if(hora != '' && fecha != ''){
        ...
        peticion.onload = function(){
            if(this.status === 200){
                ...
                if(respuesta.respuesta === 'correcto'){
                    mostrarNotificacion('Pedido Realizado.', 'correcto');
        ...
        peticion.send(Pedido);
    }else{
        mostrarNotificacion('Eliga Fecha y Hora Para Recoger el Pedido.','error');
    }
}
