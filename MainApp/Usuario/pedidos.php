            ...
            <div class="contenedor-items">
                ...
                <div class="contenedor-tabla">
                    <table id="listado-items" class="listado-items">
                        ...
                        <tbody>
                            <?php $pedidos = ObtenerPedido($_SESSION['usuario']['ID_user']);
                                if($pedidos->num_rows){
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    value="cancelar" class="btn-borrar btn" <?= ($pedido['estado'] == "COMPLETADO") ? 'disabled=""' : '' ?>><i class="fas fa-times-circle"></i></button>
